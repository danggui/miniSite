define(['UIView', getViewTemplatePath('ui/ui.tab')], function (UIView, template) {
  ...
  return _.inherit(UIView, {
    propertys: function ($super) {
      ...
      this.events = {
        'click .ct-ui-tab-mod>li': 'clickAction'
      };
    ...
    initElement: function () {
      this.el = this.$('.ct-ui-tab-current');
      this.tab = this.$('.ct-ui-tab-scrollbar');
      this.tabs = this.$('li');
...
//        var width = this.tab.css('width');
//        setTimeout($.proxy(function () {
//          this.tab.css('width', width);
//        }, this), 0);
//      }
