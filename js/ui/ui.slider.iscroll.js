define(['UIView', getViewTemplatePath('ui/ui.slider.iscroll'), 'UIScroll'], function (UIView, template, UIScroll) {
  ...
  return _.inherit(UIView, {
    ...
    _initScroll: function () {
      ...
      this.scroll = new UIScroll({
        ...
        //为了解决鼠标离屏幕时导致的问题
        onTouchEnd: $.proxy(function () {
          var self = this;
          if (self.touchEndTimeId) {
            clearTimeout(self.touchEndTimeId);
          }
          self.touchEndTimeId = setTimeout(
            function () {
              self.absDistX = 0;
              self.absDistY = 0;
            }, 600);
    ...
    addEvent: function ($super) {
      ...
      this.on('onCreate', function () {
        this.$el.addClass('ct-ui-roller-bd');
        this.$el.addClass('ct-ui-roller');
