  ...
  return _.inherit(UILayer, {
    propertys: function ($super) {
      ...
      this.events = {
        ...
        'click .dropdown-parent': 'dropdown'
      };
...
//      if (!this.datamodel.selectId) return;
    ...
    dropdown:function(e){
      $(e.currentTarget.children[0]).toggleClass("glyphicon-menu-down");
      $(e.currentTarget.children[0]).toggleClass("glyphicon-menu-up");
      _.each($("li[class='form-item-li']"),function(value, key, list){
        if($(value).attr("data-leaf-id") === e.currentTarget.getAttribute('data-id')){
          $(value).toggle();
        }
      });
    },
